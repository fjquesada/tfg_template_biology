% ============================================================|
%                                                             |
% Plantilla para TFG del Dpto. de Informatica de la EPSJ v1.0 |
%                                                             |
...
\fancyfoot[RE,LO]{{\color{gray}Facultad de Ciencias Experimentales}}
...
\newcommand{\Portada}{ %
    ...
    \begin{textblock*}{14cm}(5cm,11cm) 
        \centering
        {\singlespacing\fontsize{32}{38}\selectfont  \textbf{\TituloTFG}\\}
    \end{textblock*}
    ...
    % Anexo portada
    % \cleardoublepage
    % \includepdf[pages={1}]{imagenes/anexo_portada.pdf}
}
